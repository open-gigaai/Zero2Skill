...
> cameras. Zero2Skill does **not** require that stack — configure your own arm
...
# Set CONDA_ENV=zero2skill, CONDA_ENV_SAM3 / CONDA_ENV_ANYGRASP (official envs),
# ARM_* / CAMERA_* / CAM_FX.. / topics / extrinsics for YOUR robot.
```

2. Environments (see [docs/setup.md](docs/setup.md)):
   - **One** project conda env: `zero2skill` (capture, IK/motion, collect tooling)
...
| Component | Notes |
|-----------|--------|
| Conda `zero2skill` | Project code: capture, motion, collect stats |
